...
public class HealthRatesTest {
	...
	static HealthRatesDAOImpl hRDI ;
	static  HealthRatesDAOFileImpl hfRDI  ;
	
	 @BeforeClass
	 public static void setUpBeforeDAOClass() throws Exception {
		 int debug=1 ;

	 hRDI = new HealthRatesDAOImpl() ;
	 ...
	 @BeforeClass
	 public static void setUpBeforeDAOFileClass() throws Exception {
		 int debug=1 ;

	   hRDI = new HealthRatesDAOFileImpl(2010,"src/resources/data/hly_2010_eusilc2_1.scv","src/resources/data/hly_2010_eusilc2_1.scv") ;
	   System.out.println("Health rates, first record id: " +  hRDI.getHealthRates(1,2010,1).getId()) ;
